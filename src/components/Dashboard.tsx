...
import { Flex, Paper, Text, H2 } from '@/components/base';
...
const DashboardContent = styled.div<DebugProps>`
  display: flex;
  flex-direction: column;
  width: 100%;
  height: 100%;
...
const StatCard = styled.div<StatCardProps>`
  ...
  ${(props: StatCardProps) => props.$isOpen && `
...
const Dashboard = () => {
  ...
  return (
    <StyledContainer $padding="20px" $flex="1" data-debug={debugMode}>
      <DashboardContent data-debug={debugMode}>
