...
import { SupplementTarget } from './supplement';
import { CardProps } from '@/core/components/common/Card/Card_types';

export const createSupplementCards = (): CardProps[] => {
  return [
    {
      id: '1',
      type: 'default',
...
// 선택된 영양제에 따른 응답 메시지 생성
export const createSupplementResponse = (target: SupplementTarget, timestamp: number): TextMessage => {
  const responses = {
